    ...
    render() {
        return (
            ...
            <Modal.Dialog>
                <Modal.Header>
                    <Modal.Title>
                        <i class="fa fa-user-plus" aria-hidden="true" style={{color:'purple'}}></i> Register EJI
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    ...
                    <div className="maildiv" style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',marginTop:15}}>
                        <i class="fa fa-user fa-2x" aria-hidden="true"style={{color:'#4285F4'}}></i>
                    ...
                    <div className="maildiv" style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',marginTop:15}}>
                        <i class="fa fa-key fa-2x" aria-hidden="true"style={{color:'#4285F4'}}></i>
